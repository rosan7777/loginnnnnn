...
function sendInvoiceEmail($order_id, $user_id) {
    ...
    try {
        ...
        $mail->Username   = 'cleckfaxtraders@gmail.com'; // SMTP username
        ...
        $getemail = "SELECT USER_EMAIL FROM CLECK_USER WHERE USER_ID = :user_id";
        ...
        $emailUser = "SELECT FIRST_NAME || ' ' || LAST_NAME AS NAME FROM CLECK_USER WHERE USER_ID = :user_id";
