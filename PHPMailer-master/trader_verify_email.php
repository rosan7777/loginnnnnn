    ...
    try {
        ...
        $mail->Body    = "
                            ...
                            <body style='font-family: Arial, sans-serif; text-align: center;'>
                                ...
                                <!-- Thank you message -->
                                <p style='color: #666;'>If you have any questions or concerns, feel free to contact us at <a href='mailto:contact@CleckfaxTraderHub.com' style='color: #007bff;'>contact@CleckfaxTraderHub.com</a>.</p>
