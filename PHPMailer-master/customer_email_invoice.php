...
function sendOrderConfirmationEmail($to_email, $order_no, $total_amount, $no_of_products, $pickup_date, $pickup_time, $pickup_location) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom($smtp_username, "CleckfaxTraderHub");
        ...
        $mail->Body    = "
                            ...
                            <body style='font-family: Arial, sans-serif; text-align: center;'>
                                ...
                                <!-- Logo -->
                                <img src='' alt='Cleckfax Trader Hub Logo' style='width: 100px; height: auto; margin-bottom: 20px;'>
                                ...
                                <!-- Thank you message -->
                                <p style='color: #666;'>If you have any questions or concerns regarding your order, feel free to contact us at <a href='mailto:contact@CleckfaxTraderHub.com' style='color: #007bff;'>contact@CleckfaxTraderHub.com</a>.</p>
                            
                                <!-- HudderFoods Logo -->
                                <img src='' alt='Cleckfax Trader Hub logo' style='width: 100px; height: auto; margin-top: 20px;'>
